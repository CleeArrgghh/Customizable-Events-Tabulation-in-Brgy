        ...
        if(isset($_POST['submit'])){
            ...
            if($query->rowCount() > 0){
                ...
                try {
                    ...
                    //Recipients
                    $mail->setFrom('cleearr.canillas@lsu.edu.ph', 'Liposong Admin');
                    $mail->addAddress($email);     

                    //Content
                    $mail->isHTML(true);                                  
                    $mail->Subject = 'Reset your password';
                    $mail->Body    = "Click the following link to reset your password: https://tabulation.ccsea.cloud/judging/reset_password.php?token=$token";
